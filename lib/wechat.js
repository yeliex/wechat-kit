!function (a, b) {
  ...
  }, D = {}, E = { _completes: [] }, F = { state: 0, data: {} }, n(function () {
    B.initEndTime = m()
  }), G = {
    config: function (a) {
      D = a, k("config", a);
      ...
      n(function () {
        ...
        if (b)c(p.config, { verifyJsApiList: j(D.jsApiList) }, function () {
          ...
          for (F.state = 1, a = E._completes, d = 0, e = a.length; e > d; ++d) {
            a[d]();
          }
          E._completes = []
        }
      ...
      d(p.onMenuShareQQ, {
        complete: function () {
          c("shareQQ", {
            title: a.title || s, desc: a.desc || "", img_url: a.imgUrl || "", link: a.link || location.href
          }, a)
        }
      }, a)
